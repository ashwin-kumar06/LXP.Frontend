...
import { DeleteQuizDetails } from "../../../middleware/Quiz And Feedback Module/api";
import { GetQuizDetails } from "../../../middleware/Quiz And Feedback Module/FetchQuizApi";
import { setQuizDetailsRequest } from "../../../actions/Quiz And Feedback Module/CreateQuizAction";
import { useNavigate } from "react-router-dom";
import { editQuizDetailsRequest } from "../../../actions/Quiz And Feedback Module/EditQuizAction";
    ...
    <div>
            ...
            <div className="d-flex mt-2">
              <div className="container">
                <Button
                  ...
                  onClick={handleOpenQuizEditModal}
                >
                  <AiFillEdit /> Edit
                </Button>
                <Button
                  ...
                  onClick={handleOpenQuizDeleteModal}
                >
                  <FaTrashCan /> Delete
                </Button>
                ...
                <div className="form-group row mt-3">
                  ...
                  >
                    Quiz Title<span id="required">*</span>
                  </label>
                ...
                <div class="form-group row mt-3">
                  <label
                    ...
                    style={{ fontWeight: "bold" }}
                  >
                    Duration (In Minutes)<span id="required">*</span>
                  </label>
                  <div class="col-sm-8">
                    <input
                      type="number"
                ...
                <div class="form-group row mt-3">
                  <label
                    ...
                    style={{ fontWeight: "bold" }}
                  >
                    Grade to be Secured<span id="required">*</span>
                  </label>
                  <div class="col-sm-8">
                    <input
                      type="number"
                      class="form-control"
                      id="lbl5"
                      placeholder="Enter the Minimum Score to be Passed"
                      style={{ borderRadius: 8 }}
                      name="passMark"
                ...
                <div class="form-group row mt-3">
                  <label
                    ...
                    style={{ fontWeight: "bold" }}
                  >
                    Attempts Allowed<span id="required">*</span>
                  </label>
                  <div class="col-sm-8">
                    <input
                      type="number"
      ...
      {quizId ? (
        <div>
          <button
            ...
            className="btn btn-light mt-3 mb-5 float-left"
            style={{
              backgroundColor: "#365486",
              color: "white",
              marginLeft: "92%",
      ...
      <Modal show={showQuizDeleteModal} onHide={handleCloseQuizDeleteModal}>
          ...
          <div className="container">
            <div className="form-group row mt-3">
              <label
                ...
                style={{ fontWeight: "bold" }}
              >
                To confirm, deleting type the QuizTitle "{quizData.nameOfQuiz}
                "in the Input<span id="required">*</span>
              </label>
              <div className="col-sm-10">
                <input
                  type="text"
        ...
        <Modal.Footer style={{ backgroundColor: "rgb(237, 231, 231)" }}>
          <Button variant="secondary" onClick={handleCloseQuizDeleteModal}>
            Back
          </Button>
          <Button
            variant="danger"
      ...
      <Modal show={showQuizEditModal} onHide={handleCloseQuizEditModal}>
          ...
          <div className="container">
            <div className="form-group row mt-3">
              ...
              <div className="col-sm-8">
                ...
                />
                {error && (
                  <p style={{ color: "red", fontSize: "50" }}>{error}</p>
                )}
              </div>
            </div>
            <div class="form-group row mt-3">
            ...
            <div class="form-group row mt-3">
              ...
              <div class="col-sm-8">
                ...
                ></input>
                {errormark && (
                  <p style={{ color: "red", fontSize: "50" }}>{errormark}</p>
                )}
              </div>
            </div>
            <div class="form-group row mt-3">
        ...
        <Modal.Footer style={{ backgroundColor: "rgb(237, 231, 231)" }}>
          <Button variant="secondary" onClick={handleCloseQuizEditModal}>
            Back
          </Button>
