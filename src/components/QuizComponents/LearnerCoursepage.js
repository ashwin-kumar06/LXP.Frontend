...
//   };
  ...
  return (
    <div>
      <h5 style={{ marginTop: "5%", textAlign: "center", color: "midnightblue" }}>Learner CoursePage</h5>
              ...
              {['HTML Basic', 'HTML Elements', 'Html Attributes', 'Html Styles', 'Html Tables'].map((topic) => (
                <li key={topic}>
                  ...
                  <div className="topic-buttons">
                    <Button variant="primary" size="sm" onClick={() => { handleAddQuiz(yesQuizTopicId) }}>Take Quiz</Button>
