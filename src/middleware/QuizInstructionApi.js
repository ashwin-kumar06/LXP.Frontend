import { FETCH_QUIZINSTRUCTION_REQUEST, fetchQuizInstructionSuccess , fetchQuizInstructionFailure} from "../actions/QuizInstructionAction";
import axios from "axios";

// const API_URL = `http://localhost:5199/api/QuizEngine/topic/${action.payload}/quiz`;

export const QuizInstructionApi = ({ dispatch }) => (next) => async (action) => {
