...
import { FETCH_QUIZ_ID_REQUEST,fetchQuizIdSuccess,fetchQuizIdFailure } from '../../actions/Quiz And Feedback Module/FetchQuizIdAction';
    ...
    if (action.type === FETCH_QUIZ_ID_REQUEST) {
      try {
        ...
        const response = await axios.get(
          `http://localhost:5199/api/Get/topic/${action.payload}`
        );
