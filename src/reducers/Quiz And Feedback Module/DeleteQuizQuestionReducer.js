...
import { DELETE_QUIZ_QUESTION_REQUEST,DELETE_QUIZ_QUESTION_SUCCESS,DELETE_QUIZ_QUESTION_FAILURE } from "../../actions/Quiz And Feedback Module/DeleteQuizQuestionAction";
const initialState = { 
    deleteQuestion: null,
    loading: false,
    error: null,
