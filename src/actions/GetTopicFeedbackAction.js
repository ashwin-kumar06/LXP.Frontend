export const FETCH_ALL_TOPICFEEDBACK_REQUEST='FETCH_ALL_ALL_TOPICFEEDBACK_REQUEST';
export const FETCH_ALL_TOPICFEEDBACK_SUCCESS='FETCH_ALL_TOPICFEEDBACK_SUCCESS';
export const FETCH_ALL_TOPICFEEDBACK_FAILURE='FETCH_ALL_TOPICFEEDBACK_FAILURE';
