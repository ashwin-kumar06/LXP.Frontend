export const FETCH_ALL_QUIZ_QUESTION_REQUEST='FETCH_ALL_ALL_QUIZFEEDBACK_REQUEST';
export const FETCH_ALL_QUIZ_QUESTION_SUCCESS='FETCH_ALL_QUIZFEEDBACK_SUCCESS';
export const FETCH_ALL_QUIZ_QUESTION_FAILURE='FETCH_ALL_QUIZFEEDBACK_FAILURE';
